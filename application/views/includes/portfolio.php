        ...
        <div id="portfolio">
            <div id="portfolioEsquerda">
                <div id="menuEsquerda">
                    ...
                    <a href="#" onmouseover="troca('gmail');" onmouseout="ligar();">Gmail</a>
                    <a href="#" onmouseover="troca('hotmail');" onmouseout="ligar();">Hotmail</a>
                </div>
            <div>
            ...
            <div id="portfolioDireita">
                <div id="menuDireita">
                    ...
                    <a href="#" onmouseover="troca('youtube');" onmouseout="ligar();">Youtube</a>
